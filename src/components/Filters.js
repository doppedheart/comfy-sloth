      ...
      <form onSubmit={(e)=>e.preventDefault()}>
        ...
        <div className="form-control">
          ...
          <div>
            {categories.map((c,index)=>{
              return (
                <button key={index} className={`${category===c.toLowerCase()?'active':null}`} name='category' type='button' onClick={updateFilters}>{c}</button>
              )
            })}
          </div>
        </div>
        ...
        <div className="colors">
          {colors.map((c,index)=>{
            if(c==='all'){
              return (
                <button name='color' key={index} onClick={updateFilters} data-color='all' className={`${color === 'all'?'all-btn active':'all-btn'}`}>
                  all
                </button>
              )
            }
